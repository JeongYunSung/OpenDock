...
explicit task, runs `oma -y install` inside the dock-private workdir, and exports
generated agent files back to the project through OpenDock-managed blocks and
checksums.
