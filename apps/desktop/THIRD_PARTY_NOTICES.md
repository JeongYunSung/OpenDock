# OpenDock Desktop Third-Party Notices
...
| Component | License |
| --- | --- |
| OpenDock Desktop | MIT |
| Bundled OpenDock CLI | MIT |

## Bundled CLI JavaScript Runtime Dependencies
...
## Desktop Web Runtime Dependencies

| Package | License | Source |
| --- | --- | --- |
| @tauri-apps/api@2.11.0 | Apache-2.0 OR MIT | git+https://github.com/tauri-apps/tauri.git |
| lucide-react@0.559.0 | ISC | https://github.com/lucide-icons/lucide.git |
...
## Desktop Rust Runtime Dependencies
...
| brotli-decompressor@5.0.2 | BSD-3-Clause/MIT | https://github.com/dropbox/rust-brotli-decompressor |
...
| libappindicator-sys@0.9.0 | Apache-2.0 OR MIT | crates.io |
| libappindicator@0.9.0 | Apache-2.0 OR MIT | crates.io |
