...
| **System/tool scope** | Host package managers | Herramientas preparadas por `requires` o install, update, doctor tasks permitidas, como Homebrew, npm, Bun, pip o winget. |
