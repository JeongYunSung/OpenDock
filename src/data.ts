...
export const TEXT = {
  ko: {
    ...
    installed: "설치됨",
    logs: "로그",
    heroTitle: "AI-ready 도크 탐색",
    heroSub: "필요한 도크를 고르고, 플랫폼 릴리스를 확인하고, 명령어 한 줄로 설치하세요.",
    search: "도크 검색",
    sortDownloads: "다운로드순",
    sortRecent: "최근 업데이트순",
    sortName: "이름순",
    noDocksTitle: "표시할 도크가 없습니다",
    noDocksSub: "검색어를 바꾸거나 잠시 후 registry를 다시 새로고침하세요.",
    noVersionsTitle: "표시할 버전이 없습니다",
    noVersionsSub: "registry에 승인된 릴리스가 생기면 여기에 표시됩니다.",
    ...
    forceRetryWarning: "수정된 관리 파일을 덮어쓰거나 제거할 수 있습니다.",
    ...
    installedSub: "현재 프로젝트에 적용된 도크와 실행 준비 상태를 확인합니다.",
    dock: "도크",
    version: "버전",
    status: "상태",
    action: "작업",
    ...
    noInstalledSub: "탐색에서 필요한 도크를 설치하면 여기에 표시됩니다.",
    logsTitle: "프로젝트 로그",
    logsSub: "설치, doctor, 파일 적용 흐름을 시간순으로 확인합니다.",
    liveTail: "live tail",
    taskInstalling: "설치 진행 중",
    taskUpdating: "업데이트 진행 중",
    taskDeleting: "삭제 진행 중",
    taskDoctor: "Doctor 실행 중",
    taskWaiting: "대기 중",
    taskWorking: "작업 중",
    taskCancelling: "취소 중",
    taskCompleted: "완료",
    ...
    memberSignIn: "멤버 로그인",
    signInTitle: "로그인",
    signInSub: "Google 또는 GitHub로 프로필과 제출한 도크를 관리하세요.",
    continueGmail: "Gmail로 계속하기",
    ...
    existingProjectSub: "폴더를 선택해 현재 워크스페이스에 추가합니다.",
    ...
    memberWorkspace: "멤버 워크스페이스",
    accountInfoTitle: "내 정보",
    accountInfoSub: "로그인 계정 정보와 기본 프로필을 확인하고 관리하세요.",
    backToMain: "메인으로",
    profile: "프로필",
    email: "이메일",
    nickname: "닉네임",
  ...
  en: {
    ...
    installed: "Installed",
    logs: "Logs",
    heroTitle: "Explore AI-ready docks",
    heroSub: "Choose the docks you need, inspect platform releases, and install with one command.",
    search: "Search docks",
    sortDownloads: "Downloads",
    sortRecent: "Recently updated",
    sortName: "Name",
    noDocksTitle: "No docks to show",
    noDocksSub: "Change the search term or refresh the registry again shortly.",
    noVersionsTitle: "No versions to show",
    noVersionsSub: "Approved registry releases will appear here.",
    ...
    forceRetryWarning: "Modified managed files may be overwritten or removed.",
    ...
    installedSub: "Review docks applied to the current project and their ready state.",
    dock: "Dock",
    version: "Version",
    status: "Status",
    action: "Action",
    ...
    logsSub: "Inspect install, doctor, and file-apply events in time order.",
    liveTail: "live tail",
    taskInstalling: "Installing",
    taskUpdating: "Updating",
    taskDeleting: "Deleting",
    taskDoctor: "Running doctor",
    taskWaiting: "Waiting",
    taskWorking: "Working",
    ...
    signInTitle: "Sign in",
    signInSub: "Use Google or GitHub to manage your profile and submitted docks.",
    ...
    existingProjectSub: "Select a folder to add it to this workspace.",
    ...
    accountInfoTitle: "Account profile",
    accountInfoSub: "Review and manage your signed-in account profile.",
