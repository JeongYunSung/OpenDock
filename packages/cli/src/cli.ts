...
interface VerifiedCommandReport {
  command: string;
  dockId: string;
  file: string;
  runner: string;
...
function parseRunCommandName(value: string): string {
...
function resolveCommandSource(manifest: DockManifest, commandFile: string): string {
...
function assertCommandRunnerMatchesFile(runner: string, file: string): void {
...
function validateDeployCommands(projectDir: string, manifest: DockManifest): void {
